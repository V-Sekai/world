...
run-editor-macos:
    ./godot/bin/godot.macos.editor.double.arm64 $(if ${PROJECT_PATH},--path ${PROJECT_PATH}) -e --display-driver macos --rendering-driver vulkan

run-editor-linux:
    ./godot/bin/godot.linux.editor.double.x86_64 $(if ${PROJECT_PATH},--path ${PROJECT_PATH}) -e

run-editor-windows:
    ./godot/bin/godot.windows.editor.double.x86_64 $(if ${PROJECT_PATH},--path ${PROJECT_PATH}) -e
