...
@onready var strategic_plan = preload ("res://path_to/StrategicPlan.gd").new()
@onready var tactical_plan = preload ("res://path_to/TacticalPlan.gd").new()
@onready var operational_plan = preload ("res://path_to/OperationalPlan.gd").new()
