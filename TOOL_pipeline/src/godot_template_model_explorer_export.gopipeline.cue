...
stages: [{
	...
	jobs: [{
		...
		tasks: [{
			...
			job:              "windows_job"
			pipeline:         "model-explorer-export"
			source:           "export_windows"
			stage:            "exportStage"
			type:             "fetch"
		}, {
			...
			arguments: ["-c", "butler push export ifiregames/model-explorer-42:windows-master --userversion $GO_PIPELINE_LABEL-`date --iso=seconds --utc`"]
			command:           "/bin/bash"
			type:              "exec"
			working_directory: ""
		}]
		...
		tasks: [{
			...
			arguments: ["-c", "butler push export ifiregames/model-explorer-42:linux-master --userversion $GO_PIPELINE_LABEL-`date --iso=seconds --utc`"]
			command:           "/bin/bash"
			type:              "exec"
			working_directory: ""
		}]
