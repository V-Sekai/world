...
struct is_iterator_impl :
    public motionmatchingboost::integral_constant<
        bool,
...
struct is_iterator_impl< T* > :
    public motionmatchingboost::conjunction<
        motionmatchingboost::is_complete< T >,
        motionmatchingboost::negation< motionmatchingboost::is_function< T > >
    >::type
{
};
