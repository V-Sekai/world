...
public:
  ...
  template<typename F>
    typename motionmatchingboost::enable_if_< !motionmatchingboost::is_function<F>::value, bool >::type
  ...
  template<typename Fn>
    typename motionmatchingboost::enable_if_< motionmatchingboost::is_function<Fn>::value, bool >::type
	contains(Fn& f) const
    {
      typedef Fn* F;
      if (const F* fp = this->template target<F>())
