...
stages: [{
	...
	jobs: [{
		...
		tasks: [{
			...
			arguments: ["-c", "../godot.linuxbsd.editor.double.x86_64.llvm --export-pack \"Windows\" `pwd`/../export_windows/v_sekai_windows.exe.pck"]
			command:           "/bin/bash"
			type:              "exec"
			working_directory: "g"
		}, {
		...
		tasks: [{
			...
			arguments: ["-c", "../godot.linuxbsd.editor.double.x86_64.llvm --export-pack \"Linux\" `pwd`/../export_linuxbsd/v_sekai_linuxbsd.pck"]
			command:           "/bin/bash"
			type:              "exec"
			working_directory: "g"
		}, {
